...
but happen to share the listing prefix, are never touched. Caches saved with `scoped-to-ref: false`
have no ref in their key, so they do not match and are not pruned.
